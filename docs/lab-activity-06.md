...
- Examples
  ...
  - Remote Blinking
    - Arduino side: running `esiot-2025-2026/src/arduino/lab-activity-06/serial/remote_blinking/remote_led_withmsg.ino`)
  ...
  - Test Ping Pong
    - Arduino side: running `esiot-2025-2026/src/arduino/lab-activity-06/serial/remote_blinking/remote_pingpong.ino`)

    - Java side (being in `esiot-2025-2026/Java/serial`):
